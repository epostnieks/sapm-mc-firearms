#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Firearms / Constitutional Ratchet
=================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Firearms (Constitutional Ratchet).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "firearms",
    "domain_name": "Firearms",
    "theorem": "Constitutional Ratchet",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 10.0,
    "channels": {
        "C1_vsl_mortality": {
            "dist": "lognormal",
            "low": 330,
            ...
            "high": 560,
            "weight": 0.35,
            "description": "VSL-adjusted gun deaths (48K US + global scaling)"
        },
        "C2_healthcare_morbidity": {
            ...
            "high": 11.0,
            "weight": 0.15,
            "description": "Gunshot wound treatment, rehabilitation, disability"
        },
        "C3_criminal_justice": {
            "dist": "normal",
            "low": 7.0,
            ...
            "high": 11.0,
            "weight": 0.15,
            "description": "Incarceration, prosecution, policing costs"
        },
        "C4_lost_productivity": {
            ...
            "high": 60,
            "weight": 0.2,
            "description": "Lost earnings from premature death and disability"
        },
        "C5_community_damage": {
            "dist": "lognormal",
            "low": 8.0,
            ...
            "high": 16,
            "weight": 0.1,
            "description": "Community psychological damage, property, insurance"
        },
        "C6_governance": {
            "dist": "lognormal",
            "low": 0.5,
            ...
            "high": 1.2,
            "weight": 0.05,
            "description": "PLCAA regulatory capture, NRA lobbying distortion"
        }
    },
