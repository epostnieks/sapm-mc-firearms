# SAPM Monte Carlo — Firearms / Constitutional Ratchet
...
**β_W = 50.99** means the firearms industry destroys **$50.99 in system
...
```bash
git clone https://github.com/epostnieks/sapm-mc-firearms.git
cd sapm-mc-firearms
pip install numpy scipy
python mc_simulation.py
```

Expected output: `β_W median : 50.99` and `ΔW median : $509.9B/yr`
...
|---------|---------------|--------|--------------|
| C1_vsl_mortality | $433.6B | [$335.7B, $559.5B] | Lognormal |
| C2_healthcare_morbidity | $8.7B | [$6.7B, $10.7B] | Normal |
| C3_criminal_justice | $8.8B | [$6.8B, $10.8B] | Normal |
| C4_lost_productivity | $45.7B | [$34.8B, $60.0B] | Lognormal |
| C5_community_damage | $11.3B | [$8.0B, $16.0B] | Lognormal |
| C6_governance | $0.7B | [$0.5B, $1.2B] | Lognormal |
| **Total ΔW** | **$509.9B** | **[$404.8B, $643.4B]** | Correlated (ρ=0.3) |
...
> Postnieks, E. (2026). *SAPM Monte Carlo — Firearms (Constitutional Ratchet)*.
> GitHub: epostnieks/sapm-mc-firearms.
> https://github.com/epostnieks/sapm-mc-firearms
